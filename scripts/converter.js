function calculateCost() {
    ...
    const itemRates = {
        ...
        "60":{ // 任一附魔書價格
          "6": 3400,  //1 任一附魔書 = 3400 銅
          "9": 570,  //1 任一附魔書 = 570 金
          "1": 60,  //1 任一附魔書 = 60 綠寶石
          "16": 4, //1 任一附魔書 = 4 鑽石
        },
        "16-2":{
          "6": 800,  //1 植物/種子(2組) = 800 銅
          "9": 100,  //1 植物/種子(2組) = 100 金
          "1": 16,  //1 植物/種子(2組) = 16 綠寶石
          "16": 1,  //1 植物/種子(2組) = 1 鑽石
        },
        "16-3":{
          "6": 800,  //1 藥水(2瓶) = 800 銅
          "9": 100,  //1 藥水(2瓶) = 100 金
        ...
        "24-2":{
          "6": 15000,  //1 鑽石全套裝備 = 15000 銅
          "9": 2500,  //1 鑽石全套裝備 = 2500 金
          "1": 285,  //1 鑽石全套裝備 = 285 綠寶石
          "16": 18,  //1 鑽石全套裝備 = 2 鑽石
        }, 
        "16-4":{
            "6": 800, //1 小麥麵包(2組) = 800 銅
            "9": 100, //1 小麥麵包(2組) = 100 金
            "1": 16, //1 小麥麵包(2組) = 16 綠寶石
            "16": 1, //1 小麥麵包(2組) = 1 鑽石
        },
    };
